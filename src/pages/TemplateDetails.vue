  ...
  <div class="bg-ivoire dark:bg-zinc-950 min-h-screen text-noir dark:text-zinc-100 transition-colors duration-300">
    ...
    <div v-else>
      ...
      <Section padding="large" class="relative">
        <div class="grid grid-cols-1 items-center gap-10 sm:gap-12 lg:grid-cols-2 lg:gap-14">
          <!-- Left Content -->
          <div>
            <div class="flex flex-wrap items-center gap-3 mb-6">
              ...
              <Badge
                v-if="template.isFixedPrice"
                variant="primary"
                size="large"
              >
                Prix fixe {{ template.priceRange }}
              </Badge>
              <Badge
                v-else
            ...
            <h1 class="heading-memorial text-3xl font-semibold text-noir dark:text-zinc-100 md:text-5xl mb-6 leading-tight">
              {{ template.name }}
            </h1>
            
            <p class="text-lg text-gris dark:text-zinc-400 mb-8 leading-relaxed">
              {{ template.description }}
            </p>
            
            <div class="mb-8 text-2xl font-bold leading-snug text-doré sm:text-3xl md:text-4xl">
              {{ template.priceRange }}
            </div>
            ...
            <div class="mb-8 flex flex-col gap-3 sm:flex-row sm:gap-4">
              <Button variant="primary" size="large" @click="sendWhatsApp(template)">
                ...
                {{ template.isFixedPrice ? 'Commander' : 'Choisir ce template' }}
              </Button>
            ...
            <!-- Quick Info -->
            <div class="grid grid-cols-2 gap-3 text-sm sm:gap-4">
              ...
              <div class="flex items-center text-gris">
                ...
                {{ template.isFixedPrice ? 'Sans formule (prix fixe)' : template.plan }}
              </div>
              <div class="flex items-center text-gris">
                <svg class="w-4 h-4 mr-2 text-doré" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div class="relative">
            <div class="relative mx-auto w-full max-w-lg">
              ...
              <div class="bg-noir rounded-2xl p-2 shadow-2xl">
                <div class="bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-stone-200/90 dark:border-zinc-800 shadow-soft">
                  <!-- Screen -->
